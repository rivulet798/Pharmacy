...
public class RequestDao implements IRequestDao {
    ...
    public boolean checkExistOfRequest(int prescriptionId) throws DaoException {
        logger.debug("RequestDao.checkExistOfRequest()");
        try {
            statement = null;
            resultSet = null;
    ...
    public boolean changeRequestStatus(int requestId, int status) throws DaoException {
        logger.debug("RequestDao.changeRequestStatus()");
        try {
            statement = null;
            ...
            if (statement.executeUpdate() != 0) {
                logger.debug("RequestDao.changeRequestStatus()-success");
                return true;
            } else {
                logger.debug("RequestDao.changeRequestStatus()-failed");
                return false;
            }
        } catch (SQLException e) {
            try {
