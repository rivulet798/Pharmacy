...
public class UserDaoImpl implements UserDao {
    ...
    public boolean addUser() throws DaoException{
        logger.debug("UserDaoImpl.addUser()");
        try{
            ...
            if(statement.executeUpdate()!=0){
                ...
                logger.debug("UserDaoImpl.addUser()-failed");
                return false;
            }
    ...
    public boolean signUp(User user) throws DaoException {
        ...
        try{
            ...
            if(statement.executeUpdate()!=0){
                ...
                logger.debug("UserDaoImpl.signUp() - failed");
                return false;
            }
        }catch (SQLException e) {
            try {
    ...
    public User getUserById(int id) throws DaoException{
        logger.debug("UserDaoImpl.getUserById()");
        try {
            connectionPool = ConnectionPool.getInstance();
            connection = connectionPool.retrieve();
            statement = null;
    ...
    public boolean isLoginUnique(String login) throws DaoException{
        logger.debug("UserDaoImpl.isLoginUnique(login)");
        try {
            statement = null;
            resultSet = null;
            connectionPool = ConnectionPool.getInstance();
    ...
    public boolean isEmailUnique(String email) throws DaoException{
        logger.debug("UserDaoImpl.isEmailUnique(email)");
        try {
            statement = null;
            resultSet = null;
            connectionPool = ConnectionPool.getInstance();
