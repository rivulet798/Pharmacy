...
public class OrderDaoImpl implements OrderDao {
    ...
    public int addOrderWithPrescription(Order order) throws DaoException {
        logger.debug("OrderDaoImpl.addOrderWithPrescription()");
        try {
    ...
    public Order getOrderById(int id) throws DaoException {
        logger.debug("OrderDaoImpl.getOrderById()");
        try {
            connectionPool = ConnectionPool.getInstance();
            connection = connectionPool.retrieve();
        ...
        logger.debug("OrderDaoImpl.getOrderById() - success"+order);
        return order;
    }
    ...
    public List<Order> getOrdersByUserId(int userId) throws DaoException {
        logger.debug("OrderDaoImpl.getOrdersByUserId()");
        try {
    ...
    public List<OrderDto> getOrdersDtoByUserIdAndStatus(int userId, int status) throws DaoException {
        logger.debug("OrderDaoImpl.getOrdersDtoByUserIdAndStatus()");
        try {
            statement = null;
            resultSet = null;
        ...
        logger.debug("OrderDaoImpl.getOrdersDtoByUserIdAndStatus() - success ");
        return orderDtoList;
    }

    @Override
    public boolean changeOrderStatus(int idOrder, int idStatus) throws DaoException {
        logger.debug("OrderDaoImpl.changeOrderStatus()");
        try {
            connectionPool = ConnectionPool.getInstance();
            connection = connectionPool.retrieve();
            statement = null;
            ...
            if (statement.executeUpdate() != 0) {
                logger.debug("OrderDaoImpl.changeOrderStatus()-success");
                return true;
            } else {
                logger.debug("OrderDaoImpl.changeOrderStatus()-failed");
                return false;
            }
        } catch (SQLException e) {
            try {
